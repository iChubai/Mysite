...
### College of Computer Science, Nankai University![Image title](img/nankai(1).png){ align=right style="height:6em; border-radius: 0.5em;"}
...
**VCIP**![Image title](img/nankai(1).png){ align=right style="height:8em; border-radius: 0.5em;"}
